package com.sfn.securityservice.filters;
        ...
        if(request.getServletPath().equals("/refreshToken")){
            ...
            if(autorizationToken != null && autorizationToken.startsWith("Bearer ")){
                try{
                    ...
                    UsernamePasswordAuthenticationToken authenticatedUser = new UsernamePasswordAuthenticationToken(username,null,autorities);
